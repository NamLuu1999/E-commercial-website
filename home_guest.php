...
<!DOCTYPE html>
        ...
        <div class="site-wrapper">
            <img src="background.jpg" alt="Home" style="width:100%;">
            <div class="text-block good-font">
                <h1>THE BEST </h1>
                <h1>DEAL OF 2019</h1>
                <h1>IS HERE</h1>

                <a class ="btn btn-transparent text-white good-font" href = "products_guest.php">Buy it now</a>
                <span>$1000</span>
            </div>
        </div>
        </div>
